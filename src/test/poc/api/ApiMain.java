...
public class ApiMain {
  ...
  public void prepareRequest() {
    httpRequest =
        RestAssured.given()
            .auth()
            .oauth2("547545a3d3fbf07100f8568dd6098b1bfcbcb3a079c00bbc7c4dd1b82e64525d")
  ...
  public void getListUsers() {
    List<PersonFull> listPerson =
        httpRequest.given().get().then().extract().body().jsonPath().getList(".", PersonFull.class);
  ...
  public void addUser() {
    ...
    httpRequest.given().when().delete("/" + idPerson).then().statusCode(anyOf(is(200), is(204)));
  }
